...
- **💷 Çift Kaynak Desteği:** WinGet / Web ve Microsoft Store (MS Store) kaynakları arasında tek tıkla geçiş (Varsayılan: Normal Web).
- **���� Kurulum Kuyruğu & Sürükle-Bırak:** Kurulum sırasını dilediğiniz gibi düzenleyebirir, kuyruktayken kaynak değiştirebilirsiniz.
- **🧇 Gelişmiş Disk & Sistem Temizleyici:** 
  - Windows Temp, Kullanıãı Temp (%TEMP%), Prefetch, Geri Dönüşüm Kutusu
  - Windows Update indirme kalıntıları, Küçük Resim (Thumbnails) önbellokleri
  - Çökme raporları (WER) ve sistem kurulum logları
  - YüklǼ web tarayıcılarının (Chrome, Edge, Firefox, Brave, Opera) önbellek temizlişi
- **🛡υWindows Defender & Tehdit Koruması:** Sessiz arka planda çal��şan canɱı sayaçlı Fluent tarama motoru (Hűzlı, Tam, Özel tarama ve imza güncelleme).
- **���� Modern & Duyarlı Tasarım:** WPF tabannł, koyu/açık tema uyumlu, yüksek çözünürlüklǼ logolar ve akıcı animasyonlar.

---

H� Gereksinimler & Çalıştırma
